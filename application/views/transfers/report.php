...
<div class="container my-3">
    ...
    <form method="get" action="<?= site_url('transfers/report'); ?>" class="row g-2 mb-3">
        <div class="col-md-2">
        ...
        <div class="col-12 d-flex justify-content-end align-self-end mt-2">
            <button class="btn btn-primary" type="submit"><i class="fas fa-search"></i> กรอง</button>
        </div>
    </form>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text display-6 mb-0"><?= (int)($statistics['total'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                ...
                <ul class="list-group">
                    <?php if (!empty($statistics['top_destinations'])): ?>
                        <?php foreach ($statistics['top_destinations'] as $d): ?>
