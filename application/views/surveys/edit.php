            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="fas fa-edit"></i> แก้ไขข้อมูลสำรวจครุภัณฑ์
                    </h4>
                </div>
                <div class="card-body">
                    <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
                    
                    <?php echo form_open('surveys/edit/'.$survey['survey_id'], array('class' => 'needs-validation', 'novalidate' => '')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="survey_year" name="survey_year" 
                                       value="<?php echo set_value('survey_year', $survey['survey_year']); ?>" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="survey_date" name="survey_date" 
                                       value="<?php echo set_value('survey_date', $survey['survey_date']); ?>" required>
                                <div class="invalid-feedback">
                        ...
                        <select class="form-control" id="asset_id" name="asset_id" required>
                            ...
                            <?php foreach($assets as $asset): ?>
                                <option value="<?php echo $asset['asset_id']; ?>" 
                                        <?php echo set_select('asset_id', $asset['asset_id'], ($asset['asset_id'] == $survey['asset_id'])); ?>
                    ...
                    <div id="assetInfo" class="alert alert-info">
                        <h6><i class="fas fa-info-circle"></i> ข้อมูลครุภัณฑ์</h6>
                        <div class="row">
                            <div class="col-md-4">
                                <strong>ประเภท:</strong> <span id="assetType"><?php echo $survey['asset_type']; ?></span>
                            </div>
                            <div class="col-md-4">
                                <strong>หมายเลขซีเรียล:</strong> <span id="assetSerial"><?php echo $survey['serial_number']; ?></span>
                            </div>
                            <div class="col-md-4">
                                <strong>สถานที่:</strong> <span id="assetLocation"><?php echo $survey['current_location']; ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="condition" name="condition" required>
                            ...
                            <option value="ดี" <?php echo set_select('condition', 'ดี', ($survey['condition'] == 'ดี')); ?>>ดี</option>
                            <option value="พอใช้" <?php echo set_select('condition', 'พอใช้', ($survey['condition'] == 'พอใช้')); ?>>พอใช้</option>
                            <option value="ชำรุด" <?php echo set_select('condition', 'ชำรุด', ($survey['condition'] == 'ชำรุด')); ?>>ชำรุด</option>
                            <option value="ไม่สามารถใช้งานได้" <?php echo set_select('condition', 'ไม่สามารถใช้งานได้', ($survey['condition'] == 'ไม่สามารถใช้งานได้')); ?>>ไม่สามารถใช้งานได้</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="surveyed_by" name="surveyed_by" 
                               value="<?php echo set_value('surveyed_by', $survey['surveyed_by']); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="notes" name="notes" rows="4" 
                                  placeholder="บันทึกเพิ่มเติม (ถ้ามี)"><?php echo set_value('notes', $survey['notes']); ?></textarea>
